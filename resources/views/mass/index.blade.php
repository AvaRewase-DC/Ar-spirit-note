...
<head>
    ...
    <style>
        ...
        .toolbar {background: var(--ken-primary); color: #fff; text-align: center; padding: 14px; border-radius: 8px; margin-bottom: 16px;}
        .card {background: #fff; border-radius: 8px; padding: 14px; margin-bottom: 12px; box-shadow: 0 2px 6px rgba(0,0,0,.06);}
        .label {font-weight: bold; color: var(--ken-primary); margin-bottom: 10px; display: block;}
        .inline {display: flex; gap: 8px; align-items: center;}
        input[type="text"], input[type="tel"], select {width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 6px;}
        button, .btn {background: var(--ken-primary); color: #fff; border: 0; padding: 10px 14px; border-radius: 6px; cursor: pointer; text-decoration: none; display: inline-block;}
        .btn-outline {background: #fff; color: var(--ken-primary); border: 1px solid var(--ken-primary);}
        .hint {text-align: center; color: var(--ken-muted); margin: 18px 0;}
...
<body>
    <div class="container">
        ...
        @else
            <div class="card">
                <h3 style="margin-top:0; color:var(--ken-primary);">{{ $massSetting['massMessageTitle'] }}</h3>
